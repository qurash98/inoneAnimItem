package uz.anor_system.animcard.util;
...
public class CircleAnimationUtil {
    ...
    private WeakReference<AppCompatActivity> mContextReference;
    ...
    public CircleAnimationUtil attachActivity(AppCompatActivity activity) {
        mContextReference = new WeakReference<AppCompatActivity>(activity);
        return this;
    }
